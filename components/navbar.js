...
const Navbar = () => {
  ...
  return (
    <div className="w-full bg-gray-300 dark:bg-gray-900">
      <nav className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-0 bg-gray-300 dark:bg-gray-900">
        {/* Logo  */}
        <Disclosure>
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto ">
                <Link href="/">
                  <span className="flex items-center space-x-2 text-2xl font-medium text-indigo-800 dark:text-gray-100">
                    <span>
                    <Image
                        src="/img/logo.png"
                        alt="Logo"
                ...
                <Disclosure.Button
                  ...
                  className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-indigo-600 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700">
                  <svg
